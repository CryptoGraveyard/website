...
export const headstoneSamples = [
  {
    ...
    rarity: "Mythic",
    series: "Monthly champion",
    stone: "Obsidian",
    shape: "Monolith",
    weather: "Eclipse",
    engraving: "Broken rocket",
    flame: "Green hellfire",
    flowers: "Black roses",
    aura: "Cursed",
    origin: "Funeral of the Month",
    provenance: "Earned by MoonBagMike",
    seed: "0xBEEF-0001",
    accent: "acid"
  },
  {
    ...
    shape: "Tablet",
    weather: "Moonlight",
    engraving: "Crescent skull",
    flame: "Blue candle",
    flowers: "Moon lilies",
    aura: "Spectral",
    origin: "Founder series",
    provenance: "Founding sample class",
    seed: "0xD00M-0002",
    accent: "violet"
  },
  {
    ...
    rarity: "Rare",
    series: "Standard burial",
    stone: "Granite",
    shape: "Rounded tablet",
    weather: "Fog",
    engraving: "Tiny candle",
    flame: "None",
    flowers: "Dead daisies",
    aura: "Dusty",
    origin: "Standard burial",
    provenance: "Sample burial record",
    seed: "0xDUST-0003",
    accent: "bone"
  },
  {
    ...
    provenance: "Community sample vote",
    seed: "0xRUG-0004",
    accent: "blood"
  },
  {
    id: "CG-HS-0005",
    title: "Jade Exit Door",
    rarity: "Epic",
    series: "State funeral",
    stone: "Jade",
    shape: "Doorway",
    weather: "Ashfall",
    engraving: "Exit sign",
    ...
    flowers: "Moss blooms",
    aura: "Haunted",
    origin: "State Funeral",
    provenance: "DragonCandle ceremony",
    seed: "0xEXIT-0005",
    accent: "acid"
  },
  {
    ...
    title: "Violet Angel",
    rarity: "Legendary",
    series: "Diamond hands",
    stone: "Ancient bone",
    shape: "Broken angel",
    weather: "Storm",
    engraving: "Diamond hands",
    flame: "Violet flame",
    flowers: "Night orchids",
    aura: "Celestial",
    origin: "Most Diamond Hands",
    provenance: "Earned by VaultWizard",
    seed: "0xHODL-0006",
    accent: "violet"
  },
  {
    ...
    aura: "Archival",
    origin: "Rug Survivor",
    provenance: "Receipts archived",
    seed: "0xNOTE-0007",
    accent: "bone"
  },
  {
    id: "CG-HS-0008",
    title: "Shattered Candle",
    rarity: "Common",
    series: "Open edition",
    stone: "Chipped slate",
    shape: "Small tablet",
    weather: "Cold fog",
    engraving: "Red wick",
    flame: "Tiny red flame",
    flowers: "None",
    aura: "Quiet",
    origin: "Standard burial",
    provenance: "Demo open edition",
    seed: "0xASH-0008",
    accent: "blood"
  }
] as const;
